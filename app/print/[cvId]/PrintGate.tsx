...
const unlocks = [
  'Unlimited clean PDF exports — no caps, ever',
  'No "Created with CV Prime free" watermark',
  'All 8 premium templates',
  'Unlimited ATS fix & AI rewrites',
];

export function PrintGate(): JSX.Element {
  return (
      ...
      <div className="w-full max-w-md">
        ...
        <div className="mt-6 text-center">
          ...
          <p className="mt-3 text-base leading-7 text-slate-500">
            Free accounts include 3 PDF exports. Upgrade to Pro for unlimited
            clean downloads — no refresh, no workaround, no limit.
          </p>
        </div>
        ...
        <div className="mt-6 space-y-3">
          <UpgradeModal
            triggerLabel="Upgrade to Pro — unlock unlimited exports"
        ...
        <p className="mt-5 text-center text-xs text-slate-400">
          Already upgraded?{' '}
          <a href="" className="font-semibold text-slate-700 underline-offset-2 hover:underline" onClick={(e) => { e.preventDefault(); window.location.reload(); }}>
            Refresh this page
          </a>
        </p>
      </div>
