...
const faqs = [
  ...
  },
  {
    ...
    a: 'Enhancv charges in USD, with plans typically starting at $12–$20/month (approximately ₹1,000–₹1,700/month). CV Prime is ₹249/month and accepts UPI — making it 4–7× more affordable for Indian users, while offering more India-relevant features like ATS scoring and India role guides.',
  },
  {
...
export default function CvPrimeVsEnhancvPage(): JSX.Element {
  return (
    <main className="min-h-screen bg-white text-slate-950">
        ...
        <div className="mx-auto max-w-5xl">
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="rounded-2xl border-2 border-cyan-400 bg-cyan-50 p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">Best for ATS & Indian job seekers</p>
                </div>
              </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-slate-200 font-display text-sm font-bold text-slate-700">E</div>
                <div>
                  <p className="font-display text-lg font-bold text-slate-900">Enhancv</p>
                  <p className="text-sm text-slate-600">Visual-first CV builder</p>
                </div>
              </div>
              <ul className="mt-5 space-y-2 text-sm text-slate-700">
      ...
      <section className="border-b border-amber-200 bg-amber-50 px-5 py-8">
        <div className="mx-auto max-w-5xl">
          <div className="flex items-start gap-4">
            <div className="text-2xl">⚠️</div>
            <div>
              <p className="font-display font-bold text-amber-900">Enhancv template ATS warning</p>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-200 bg-slate-50">
                  ...
                  <th className="p-4 text-center font-semibold text-slate-600">Enhancv</th>
                </tr>
              </thead>
              <tbody>
                {features.map((row, i) => (
                  <tr key={row.feature} className={i % 2 === 0 ? 'bg-white' : 'bg-slate-50/40'}>
                    ...
                    <td className="p-4 text-center">
                      {row.enhancv === 'yes' ? (
                        ...
                        <span className="inline-block rounded-full bg-slate-100 px-2 py-0.5 text-xs font-bold text-slate-600">{row.enhancv}</span>
                      )}
                    </td>
                  </tr>
                ))}
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6">
              <p className="font-display text-lg font-bold text-slate-900">Enhancv pricing (approx. in INR)</p>
              <div className="mt-4 space-y-3">
                <div className="flex items-baseline justify-between">
                  <p className="font-medium text-slate-700">Free plan</p>
                ...
                <div className="flex items-baseline justify-between">
                  ...
                  <p className="font-display font-bold text-slate-600">~₹1,200–1,700/mo</p>
                </div>
                <div className="flex items-baseline justify-between">
                  <p className="font-medium text-slate-700">Annual plan (per month)</p>
                  <p className="font-display font-bold text-slate-600">~₹750–1,000/mo</p>
                </div>
              </div>
      ...
      <section className="px-5 py-20">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
              <p className="font-display font-bold text-slate-900">Enhancv might suit you if you:</p>
              <ul className="mt-4 space-y-2 text-sm text-slate-700">
                {[
