    ...
    <main className="min-h-screen bg-white/[0.04] text-white">
      ...
      <section className="px-5 py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-3 text-slate-400">CV Prime&apos;s AI is calibrated for the resume formats and keyword patterns used by these Mumbai employers.</p>
      ...
      <section className="bg-white/[0.03] px-5 py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-3 text-slate-400">Build a role-specific resume tailored to Mumbai&apos;s job market in one click.</p>
      ...
      <section className="px-5 py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-3 text-slate-400">Mumbai JDs in banking, FMCG, and consulting consistently include these keywords. CV Prime checks your resume against them automatically.</p>
      ...
      <section className="bg-white/[0.03] px-5 py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-3 text-slate-400">Each Mumbai business district has a distinct industry concentration. Target your resume accordingly.</p>
      ...
      <CityRoleMatrixLinks citySlug="mumbai" cityName="Mumbai" />
