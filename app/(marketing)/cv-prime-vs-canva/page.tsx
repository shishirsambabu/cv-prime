        ...
        <div className="mx-auto max-w-5xl">
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="rounded-2xl border-2 border-cyan-400 bg-cyan-500/10 p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-300">Best for ATS-screened job applications</p>
                </div>
              </div>
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-slate-200 font-display text-sm font-bold text-slate-300">C</div>
                <div>
                  <p className="font-display text-lg font-bold text-white">Canva</p>
                  <p className="text-sm text-slate-300">Design tool — not a resume optimiser</p>
                </div>
              </div>
              <ul className="mt-5 space-y-2 text-sm text-slate-300">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-white/10 bg-white/[0.03]">
                  ...
                  <th className="p-4 text-center font-semibold text-slate-300">Canva</th>
                </tr>
              </thead>
              <tbody>
                {features.map((row, i) => (
                  <tr key={row.feature} className={i % 2 === 0 ? 'bg-white/[0.06]' : 'bg-white/[0.03]'}>
                    ...
                    <td className="p-4 text-center">
                      {row.canva === 'yes' ? (
                        ...
                        <span className="inline-block rounded-full bg-white/[0.05] px-2 py-0.5 text-xs font-bold text-slate-300">{row.canva}</span>
                      )}
                    </td>
                  </tr>
                ))}
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-2">
            <div className="rounded-2xl border border-red-200 bg-red-50 p-6">
              <p className="font-display text-lg font-bold text-white">What Canva resumes typically include</p>
            ...
            <div className="rounded-2xl border border-cyan-400/30 bg-cyan-500/10 p-6">
              <p className="font-display text-lg font-bold text-white">What CV Prime templates guarantee</p>
              <ul className="mt-4 space-y-2 text-sm text-slate-300">
                {[
      ...
      <section className="px-5 py-20">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
              <p className="font-display font-bold text-white">Canva might suit you if you:</p>
              <ul className="mt-4 space-y-2 text-sm text-slate-300">
                {[
          ...
          __html: JSON.stringify([
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { '@type': 'ListItem', position: 2, name: 'CV Prime vs Canva', item: 'https://cv-prime.in/cv-prime-vs-canva' },
              ],
            },
          ]),
        }}
