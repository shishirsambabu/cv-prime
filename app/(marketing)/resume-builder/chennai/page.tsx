      ...
      <section className="relative overflow-hidden bg-rose-950 px-5 py-24 text-white">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Link href="/signup?next=/ai-cv" className="inline-flex items-center gap-2 rounded-full bg-rose-400 px-8 py-3.5 text-base font-bold text-slate-950 transition hover:bg-rose-300">
              ...
              <tbody className="divide-y divide-slate-100">
                {topCompanies.map((company) => (
                  <tr key={company.name}>
                    ...
                    <td className="py-3"><span className="rounded-full bg-rose-50 px-2 py-0.5 text-xs font-bold text-rose-700">{company.ats}</span></td>
                  </tr>
                ))}
              </tbody>
            </table>
