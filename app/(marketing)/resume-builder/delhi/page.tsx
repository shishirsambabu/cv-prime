    ...
    <main className="min-h-screen bg-white/[0.04] text-white">
      ...
      <section className="relative overflow-hidden bg-purple-950 px-5 py-24 text-white">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Link href="/signup?next=/ai-cv" className="inline-flex items-center gap-2 rounded-full bg-purple-400 px-8 py-3.5 text-base font-bold text-white transition hover:bg-purple-300">
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            {[
              ...
              <Link key={link.href} href={link.href} className="rounded-full border border-white/10 bg-white/[0.03] px-4 py-2 text-sm font-semibold text-slate-300 hover:border-purple-300 hover:text-purple-700 transition">
                {link.label} →
              </Link>
            ))}
          </div>
      ...
      <section className="bg-purple-950 px-5 py-20 text-white">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <Link href="/signup?next=/ai-cv" className="mt-8 inline-flex items-center gap-2 rounded-full bg-purple-400 px-10 py-4 text-base font-bold text-white hover:bg-purple-300 transition">
            Build my Delhi resume free <ArrowRight className="h-4 w-4" />
          </Link>
        </div>
      </section>
