...
export const metadata: Metadata = {
  ...
  description:
    'Free AI resume optimizer for India. Paste a job description to see your ATS score, keyword gaps, and AI rewrites that fix your resume and boost callbacks.',
