...
export const metadata: Metadata = {
  ...
  description:
    'India salary guide for 30 job roles in 2026. Fresher to leadership pay bands, city-wise breakdowns (Bangalore, Mumbai, Hyderabad), company-type comparisons, and negotiation tips.',
  keywords: [
  ...
  openGraph: {
    title: 'Salary by Job Role India 2026 — Complete Guide | CV Prime',
    description: 'India salary guide for 30 job roles. Fresher to leadership, city-wise, company-type comparisons.',
      ...
      <section className="bg-slate-950 px-5 py-20 text-white">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-slate-300">
            Research-backed salary ranges for 30 job roles in India. Covers fresher to leadership pay bands, city-wise salary differences, company-type comparisons, and negotiation tactics.
          </p>
          ...
          __html: JSON.stringify([
            {
              ...
              description: 'Research-backed salary ranges for 30 job roles in India. Fresher to leadership, city-wise, company-type comparisons.',
              url: 'https://cv-prime.in/salary',
