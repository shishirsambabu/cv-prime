    ...
    <main className="min-h-screen bg-white text-slate-950">
      ...
      <section className="px-5 py-20">
        <div className="mx-auto max-w-4xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-slate-500">Layouts that put your stack and impact first</p>
          </div>
      ...
      <section className="px-5 py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-3 text-slate-500">Mirror the JD&apos;s exact terms — CV Prime checks your resume against them automatically.</p>
      ...
      <section className="bg-slate-50 px-5 py-20">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-10 space-y-3">
            {tips.map((t) => (
              <div key={t} className="flex items-start gap-3 rounded-xl border border-slate-200 bg-white p-4">
