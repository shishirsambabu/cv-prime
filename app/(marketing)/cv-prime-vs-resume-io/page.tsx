...
const features = [
  ...
  { feature: 'UPI / Razorpay payment', cvPrime: 'yes', resumeio: 'no', note: 'CV Prime accepts UPI, net banking, Indian debit/credit cards' },
            ...
            <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-6">
              ...
              <ul className="mt-4 space-y-2 text-sm text-slate-700">
                {[
                  ...
                  'You need to pay in INR (UPI, Razorpay, net banking)',
