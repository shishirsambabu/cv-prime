...
const features = [
  ...
  },
  {
    ...
    cvPrime: 'yes',
    googleDocs: 'yes',
    note: 'CV Prime is free + ₹999 one-time lifetime Pro. Google Docs is free with any Google account.',
  },
  {
  ...
  },
  {
    ...
    cvPrime: 'limited',
    googleDocs: 'yes',
    note: 'Google Docs is completely free with a Google account. CV Prime has a free plan with 3 exports; unlimited exports require Lifetime Pro (₹999 one-time).',
  },
  {
