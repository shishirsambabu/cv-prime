        ...
        <div className="mx-auto max-w-5xl">
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="rounded-2xl border-2 border-cyan-400 bg-cyan-50 p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">Builder + ATS scorer + AI rewriter for India</p>
                </div>
              </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-slate-200 font-display text-sm font-bold text-slate-700">RW</div>
                <div>
                  <p className="font-display text-lg font-bold text-slate-900">Resume Worded</p>
                  <p className="text-sm text-slate-600">US-focused resume & LinkedIn feedback tool</p>
                </div>
              </div>
              <ul className="mt-5 space-y-2 text-sm text-slate-700">
      ...
      <section className="px-5 py-20">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-3 text-slate-500">
            ...
            <Link href="/ai-resume-rewriter" className="text-cyan-700 underline hover:text-cyan-900">AI resume rewriter</Link>.
          </p>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-200 bg-slate-50">
                  ...
                  <th className="p-4 text-center font-semibold text-slate-600">Resume Worded</th>
                </tr>
              </thead>
              <tbody>
                {features.map((row, i) => (
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6">
              <p className="font-display font-bold text-slate-900">Resume Worded might suit you if you:</p>
              <ul className="mt-4 space-y-2 text-sm text-slate-700">
                {[
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <Link href="/ai-resume-rewriter" className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-6 py-3 text-sm font-bold text-slate-700 hover:border-cyan-300 hover:text-cyan-700">
