      ...
      <main className="min-h-screen bg-white text-slate-900">
        ...
        <article className="px-4 py-12">
          <div className="mx-auto max-w-3xl">
            ...
            <h2 className="mb-4 text-2xl font-bold text-slate-900">What is a resume headline?</h2>
            ...
            <div className="mb-8 rounded-2xl border border-slate-200 bg-slate-50 p-5">
              <div className="mb-2 text-sm font-semibold text-slate-500">Example of resume headline vs summary</div>
              <div className="space-y-3">
                <div>
                  <div className="text-xs text-slate-400 mb-1">HEADLINE (1 line)</div>
                  <div className="rounded-lg bg-white border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-800">
                ...
                <div>
                  ...
                  <div className="rounded-lg bg-white border border-slate-200 px-4 py-2 text-sm text-slate-700">
            ...
            <h2 className="mb-4 text-2xl font-bold text-slate-900">The resume headline formula</h2>
            <p className="mb-6 text-slate-700">Most effective resume headlines follow this 3-element structure:</p>
            <div className="mb-8 overflow-hidden rounded-2xl border border-slate-200">
              <table className="w-full text-sm">
                <thead className="bg-slate-50">
                  <tr>
                    <th className="p-3 text-left font-semibold text-slate-700">Element</th>
                    <th className="p-3 text-left font-semibold text-slate-700">Example</th>
                    <th className="p-3 text-left font-semibold text-slate-700">Why it matters</th>
                  </tr>
                </thead>
                <tbody>
                  {formula.map((f, i) => (
                    <tr key={f.element} className={i % 2 === 0 ? 'bg-white' : 'bg-slate-50/50'}>
                      <td className="p-3 font-semibold text-slate-800">{f.element}</td>
                      <td className="p-3 text-brand font-medium">{f.example}</td>
                      <td className="p-3 text-slate-600 text-xs">{f.notes}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            </div>
            <div className="mb-10 rounded-xl bg-brand/5 border border-brand/20 p-4 text-sm text-slate-700">
            ...
            <h2 className="mb-6 text-2xl font-bold text-slate-900">30+ resume headline examples</h2>
            <div className="mb-10 space-y-2">
              {examples.map((e) => (
                <div key={e.headline} className="flex items-start gap-3 rounded-xl border border-slate-200 bg-white p-3">
                  <div className="flex shrink-0 flex-col gap-1">
                    <span className="rounded-full bg-slate-100 px-2 py-0.5 text-xs font-medium text-slate-600">{e.role}</span>
                    <span className="rounded-full bg-brand/10 px-2 py-0.5 text-xs font-medium text-brand">{e.level}</span>
                  </div>
                  <p className="font-semibold text-slate-800 text-sm leading-relaxed">{e.headline}</p>
                </div>
              ))}
            </div>

            <h2 className="mb-6 text-2xl font-bold text-slate-900">Bad resume headline examples — and why they fail</h2>
            ...
            <h2 className="mb-4 text-2xl font-bold text-slate-900">When to use a headline vs an objective</h2>
            <div className="mb-10 grid gap-4 sm:grid-cols-2">
              <div className="rounded-xl border border-slate-200 p-4">
                <h3 className="mb-2 font-semibold text-slate-900">Use a headline when:</h3>
              ...
              <div className="rounded-xl border border-slate-200 p-4">
                <h3 className="mb-2 font-semibold text-slate-900">Use an objective when:</h3>
                <ul className="space-y-1.5">
