    ...
    <main className="min-h-screen bg-white/[0.04] text-white">
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-3">
            {[
              ...
              <div key={card.heading} className="rounded-2xl border border-white/10 bg-white/[0.03] p-5">
      ...
      <section className="px-5 py-16">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-8 space-y-4">
            {insteadOf.map((item) => (
              <div key={item.remove} className="grid gap-2 rounded-2xl border border-white/10 p-5 md:grid-cols-2">
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-3">
            {[
              ...
              <div key={ref.num} className="rounded-2xl border border-white/10 bg-white/[0.04] p-5">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-300">{ref.body}</p>
              </div>
            ))}
          </div>
          <div className="mt-8 rounded-2xl border border-amber-400/20 bg-amber-500/10 p-5">
            <p className="text-sm font-bold text-amber-200">Always get consent before naming someone as a reference</p>
          ...
          <div className="mt-6 overflow-hidden rounded-2xl border border-white/10">
            <table className="w-full text-sm">
              <thead className="bg-white/[0.03]">
                <tr>
                  <th className="px-4 py-3 text-left font-bold text-slate-300">Field</th>
                  <th className="px-4 py-3 text-left font-bold text-slate-300">Example</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-white/10">
                {referenceFormat.map((row) => (
                  <tr key={row.field} className="bg-white/[0.04]">
                    <td className="px-4 py-3 font-semibold text-slate-300">{row.field}</td>
                    <td className="px-4 py-3 font-mono text-slate-300">{row.example}</td>
                  </tr>
                ))}
              </tbody>
            </table>
