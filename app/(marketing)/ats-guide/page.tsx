...
export const metadata: Metadata = {
  ...
  description:
    'Role-specific ATS CV guides for 30 professions in India. Learn the exact ATS keywords, formatting rules, and common ATS failures for your job role. Updated 2026.',
  keywords: [
    'ats cv guide india',
  ...
  openGraph: {
    title: 'ATS CV Guide by Profession — Pass Any ATS in India 2026 | CV Prime',
    description: 'Role-specific ATS guides for 30 professions. ATS keywords, formatting rules, and common failures by job role.',
          ...
          __html: JSON.stringify([
            {
              ...
              description: 'Role-specific ATS guides for 30 professions in India. ATS keywords, formatting rules, and common failures.',
              url: 'https://cv-prime.in/ats-guide',
