...
export const metadata: Metadata = {
  ...
  description:
    'Role-specific ATS CV guides for 36 professions in India. Learn the exact ATS keywords, formatting rules, and common ATS failures for your job role. Updated 2026.',
  keywords: [
    'ats cv guide india',
  ...
  openGraph: {
    title: 'ATS CV Guide by Profession — Pass Any ATS in India 2026 | CV Prime',
    description: 'Role-specific ATS guides for 36 professions. ATS keywords, formatting rules, and common failures by job role.',
      ...
      <section className="bg-slate-950 px-5 py-20 text-white">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-slate-300">
            Role-specific ATS guides for 36 professions in India. Exact ATS keywords, critical formatting rules, and the most common ATS failures — tailored to your job role.
          </p>
          ...
          __html: JSON.stringify([
            {
              ...
              description: 'Role-specific ATS guides for 36 professions in India. ATS keywords, formatting rules, and common failures.',
              url: 'https://cv-prime.in/ats-guide',
