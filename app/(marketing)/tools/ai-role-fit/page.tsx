...
export default function AiRoleFitPage(): JSX.Element {
  return (
    <AiToolLayout
      ...
      schemaName="AI Role-Fit Finder"
      schemaDescription="Find the job roles you're most competitive for right now, with fit scores and gaps to close."
      featureList={['Role fit scoring from your resume', 'Match rationale per role', 'Gap-to-close guidance', 'Runs on your own AI key']}
    >
      <RoleFitAI />
    </AiToolLayout>
  );
