  ...
  return (
    ...
    >
      ...
      <LegalSection title="2. Data we collect">
        ...
        <p><strong>Payment data</strong> — payment status, billing reference IDs, and subscription tier. We do not store card numbers, bank details, or UPI credentials; our billing partner handles payment processing.</p>
      ...
      <LegalSection title="7. Data sharing">
        ...
        <LegalList items={[
          ...
          'Billing partner — payment processing (India). Subject to the partner privacy policy.',
