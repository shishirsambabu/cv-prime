...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. The AI cover letter generator is included in the free plan with 3 cover letter exports. Lifetime Pro (₹999 one-time) gives unlimited cover letter generation and exports — useful if you are applying to multiple roles.',
      },
    },
    {
      '@type': 'Question',
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Yes. The AI cover letter generator is included in the free plan with 3 cover letter exports. Lifetime Pro (₹999 one-time) gives unlimited cover letter generation — useful if you are applying to multiple roles.',
  },
  {
