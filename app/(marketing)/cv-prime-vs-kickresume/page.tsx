...
const features = [
  ...
  { feature: 'India-specific CV guides', cvPrime: 'yes', kickresume: 'no', note: 'CV Prime has 49 India role guides; Kickresume content is global/European focused' },
