          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            {stages.map((s, i) => (
              <div key={s} className="flex items-center gap-3">
                <span className="rounded-xl border border-white/10 bg-white/[0.04] px-4 py-2 text-sm font-bold text-slate-300">{s}</span>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-white/10">
                  ...
                  <th className="pb-3 text-left text-slate-400">Spreadsheet</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-white/10">
                {vsSpreadsheet.map(([a, b]) => (
                  <tr key={a} className="align-top">
                    ...
                    <td className="py-3 text-slate-400">{b}</td>
                  </tr>
                ))}
              </tbody>
            </table>
