...
const features = [
  ...
  { feature: 'UPI / Cashfree payment', cvPrime: 'yes', novoresume: 'no', note: 'CV Prime accepts UPI, net banking, Indian debit/credit cards' },
...
const faqs = [
  {
    ...
    a: 'For Indian job seekers, CV Prime offers several significant advantages over Novoresume: ATS scoring against specific job descriptions, INR pricing (Novoresume charges in USD at ≈₹1,300–₹1,600/month equivalent), UPI and Cashfree payment support, and India-specific content for 30 job roles. Novoresume is a well-designed template builder but lacks ATS optimization features critical for the Indian job market.',
  },
  {
  ...
  },
  {
    ...
    a: 'Novoresume charges in USD at approximately $16–19/month for Pro plans. At current exchange rates, this equals ₹1,300–₹1,600/month — 5x to 6x the cost of CV Prime Pro (₹249/month). Novoresume does not accept Indian payment methods like UPI, Cashfree, or net banking, and Indian bank foreign transaction fees apply.',
  },
  {
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="rounded-2xl border-2 border-cyan-400 bg-cyan-50 p-6">
              ...
              <ul className="mt-5 space-y-2 text-sm text-slate-700">
                ...
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-cyan-600" /> UPI / Cashfree / net banking</li>
              </ul>
            </div>
