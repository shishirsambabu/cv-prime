...
const features = [
  ...
  { feature: 'India-specific content library', cvPrime: 'yes', novoresume: 'no', note: 'CV Prime has 49 India-specific guides; Novoresume\'s content is US/European focused' },
