...
const features = [
  ...
  { feature: 'Razorpay / UPI payment', cvPrime: 'yes', teal: 'no', note: 'CV Prime accepts UPI, net banking, Indian debit cards via Razorpay' },
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Teal charges in USD, with paid plans typically ranging from $9–$29/month (approximately ₹750–₹2,500/month at current rates). CV Prime is ₹249/month and accepts UPI, Razorpay, and net banking — making it 3–10× more affordable for Indian users.',
  },
  {
        ...
        <div className="mx-auto max-w-5xl">
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-slate-200 font-display text-sm font-bold text-slate-700">T</div>
                <div>
                  <p className="font-display text-lg font-bold text-slate-900">Teal</p>
                  <p className="text-sm text-slate-600">US-focused job search platform</p>
                </div>
              </div>
              <ul className="mt-5 space-y-2 text-sm text-slate-700">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-200 bg-slate-50">
                  ...
                  <th className="p-4 text-center font-semibold text-slate-600">Teal</th>
                </tr>
              </thead>
              <tbody>
                {features.map((row, i) => (
                  <tr key={row.feature} className={i % 2 === 0 ? 'bg-white' : 'bg-slate-50/40'}>
                    ...
                    <td className="p-4 text-center">
                      {row.teal === 'yes' ? (
                        ...
                        <span className="inline-block rounded-full bg-slate-100 px-2 py-0.5 text-xs font-bold text-slate-600">{row.teal}</span>
                      )}
                    </td>
                  </tr>
                ))}
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6">
              <p className="font-display text-lg font-bold text-slate-900">Teal pricing (approx. in INR)</p>
              <div className="mt-4 space-y-3">
                <div className="flex items-baseline justify-between">
                  <p className="font-medium text-slate-700">Free plan</p>
                ...
                <div className="flex items-baseline justify-between">
                  <p className="font-medium text-slate-700">Plus (monthly)</p>
                  <p className="font-display font-bold text-slate-600">~₹750–1,200/mo</p>
                </div>
                <div className="flex items-baseline justify-between">
                  <p className="font-medium text-slate-700">Pro (monthly)</p>
                  <p className="font-display font-bold text-slate-600">~₹2,000–2,500/mo</p>
                </div>
              </div>
      ...
      <section className="px-5 py-20">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
              <p className="font-display font-bold text-slate-900">Teal might suit you if you:</p>
              <ul className="mt-4 space-y-2 text-sm text-slate-700">
                {[
