...
import { ArrowRight, MapPin, CheckCircle2, Briefcase } from 'lucide-react';
    ...
    <main className="min-h-screen bg-white text-slate-950">
      ...
      <section className="px-5 py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-3 text-slate-500">CV Prime&apos;s AI is calibrated for the ATS formats used by these Chennai employers.</p>
      ...
      <section className="bg-slate-50 px-5 py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-3 text-slate-500">Build a role-specific resume tailored to Chennai&apos;s job market in one click.</p>
      ...
      <section className="px-5 py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-3 text-slate-500">Chennai JDs in IT, automotive, and engineering consistently include these terms.</p>
