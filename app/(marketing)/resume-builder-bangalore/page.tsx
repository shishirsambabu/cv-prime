    ...
    <main className="min-h-screen bg-white/[0.04] text-white">
      ...
      <section className="bg-white/[0.03] px-5 py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-3 text-slate-400">Build a role-specific resume tailored to Bangalore&apos;s job market in one click.</p>
      ...
      <section className="px-5 py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-3 text-slate-400">Bangalore tech JDs consistently include these keywords. CV Prime checks your resume against them automatically.</p>
      ...
      <section className="bg-white/[0.03] px-5 py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-3 text-slate-400">Different areas of Bangalore have distinct industry concentrations. Target your resume accordingly.</p>
