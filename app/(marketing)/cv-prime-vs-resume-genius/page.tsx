...
const features = [
  ...
  { feature: 'India-specific CV guides', cvPrime: 'yes', competitor: 'no', note: 'CV Prime has 49 India-specific role guides; Resume Genius content is US-focused' },
...
const canonicalUrl = 'https://cv-prime.in/cv-prime-vs-resume-genius';
    ...
    <main className="min-h-screen bg-white/[0.04] text-white">
        ...
        <div className="mx-auto max-w-5xl">
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-slate-200 font-display text-sm font-bold text-slate-300">RG</div>
                <div>
                  <p className="font-display text-lg font-bold text-white">Resume Genius</p>
                  <p className="text-sm text-slate-300">US-focused template builder</p>
                </div>
              </div>
              <ul className="mt-5 space-y-2 text-sm text-slate-300">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-white/10 bg-white/[0.03]">
                  ...
                  <th className="p-4 text-center font-semibold text-slate-300">Resume Genius</th>
                </tr>
              </thead>
              <tbody>
                {features.map((row, i) => (
      ...
      <section className="bg-white/[0.03] px-5 py-20">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-3 text-slate-400">For Indian job seekers, pricing in INR and acceptance of Indian payment methods matters significantly.</p>
          <div className="mt-8 grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-6">
              <p className="font-display text-lg font-bold text-white">Resume Genius pricing (approx. in INR)</p>
              <div className="mt-4 space-y-3">
                <div className="flex items-baseline justify-between">
                  <p className="font-medium text-slate-300">Free plan</p>
                ...
                <div className="flex items-baseline justify-between">
                  ...
                  <p className="font-display font-bold text-slate-300">~₹660/mo (USD)</p>
                </div>
                <div className="flex items-baseline justify-between">
                  <p className="font-medium text-slate-300">Annual plan</p>
                  <p className="font-display font-bold text-slate-300">~₹500/mo (USD)</p>
                </div>
              </div>
      ...
      <section className="px-5 py-20">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
              <p className="font-display font-bold text-white">Resume Genius might suit you if you:</p>
              <ul className="mt-4 space-y-2 text-sm text-slate-300">
                {[
          ...
          __html: JSON.stringify([
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { '@type': 'ListItem', position: 3, name: 'CV Prime vs Resume Genius', item: 'https://cv-prime.in/cv-prime-vs-resume-genius' },
              ],
            },
          ]),
        }}
