...
const features = [
  ...
  { feature: 'India-specific CV guides', cvPrime: 'yes', competitor: 'no', note: 'CV Prime has 36 India-specific role guides; Resume Genius content is US-focused' },
        ...
        <div className="mx-auto max-w-5xl">
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-slate-200 font-display text-sm font-bold text-slate-700">RG</div>
                <div>
                  <p className="font-display text-lg font-bold text-slate-900">Resume Genius</p>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-200 bg-slate-50">
                  ...
                  <th className="p-4 text-center font-semibold text-slate-600">Resume Genius</th>
                </tr>
              </thead>
              <tbody>
                {features.map((row, i) => (
