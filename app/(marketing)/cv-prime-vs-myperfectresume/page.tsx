...
const features = [
  ...
  { feature: 'INR pricing (India)', cvPrime: 'yes', competitor: 'no', note: 'CV Prime is ₹999 one-time lifetime; MyPerfectResume charges in USD (typically $2.95 trial then $34.95/month)' },
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Yes, on two counts. First, MyPerfectResume typically offers a low-cost "trial" (around $2.95 for a week) that auto-renews at $34.95/month — a pricing model that has drawn complaints about unexpected charges. Second, all pricing is in USD, which translates to approximately ₹290 for the trial and ₹2,900–₹3,500/month for the full subscription — far more expensive than CV Prime Lifetime Pro (₹999 one-time) and incompatible with Indian payment methods like UPI.',
  },
  {
        ...
        <div className="mx-auto max-w-5xl">
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-slate-200 font-display text-sm font-bold text-slate-700">MP</div>
                <div>
                  <p className="font-display text-lg font-bold text-slate-900">MyPerfectResume</p>
                  <p className="text-sm text-slate-600">US-focused template & bullet builder</p>
                </div>
              </div>
              <ul className="mt-5 space-y-2 text-sm text-slate-700">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-200 bg-slate-50">
                  ...
                  <th className="p-4 text-center font-semibold text-slate-600">MyPerfectResume</th>
                </tr>
              </thead>
              <tbody>
                {features.map((row, i) => (
