...
export const metadata: Metadata = {
  ...
  description:
    'Zety has no ATS scoring and charges $5.99-23.70/month in USD with no Indian payment support. CV Prime adds ATS analysis, UPI payments, and India-specific guides for ₹999 one-time.',
  keywords: [
    'cv prime vs zety',
        ...
        <div className="mx-auto max-w-5xl">
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-slate-200 font-display text-sm font-bold text-slate-300">Z</div>
                <div>
                  <p className="font-display text-lg font-bold text-white">Zety</p>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-white/10 bg-white/[0.03]">
                  ...
                  <th className="p-4 text-center font-semibold text-slate-300">Zety</th>
                </tr>
              </thead>
              <tbody>
                {features.map((row, i) => (
                  <tr key={row.feature} className={i % 2 === 0 ? 'bg-white/[0.06]' : 'bg-white/[0.03]'}>
                    ...
                    <td className="p-4 text-center">
                      {row.zety === 'yes' ? (
                        ...
                        <span className="inline-block rounded-full bg-white/[0.05] px-2 py-0.5 text-xs font-bold text-slate-300">{row.zety}</span>
                      )}
                    </td>
                  </tr>
                ))}
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-6">
              <p className="font-display text-lg font-bold text-white">Zety pricing (approx. in INR)</p>
              <div className="mt-4 space-y-3">
                <div className="flex items-baseline justify-between">
                  <p className="font-medium text-slate-300">Free plan</p>
                ...
                <div className="flex items-baseline justify-between">
                  <p className="font-medium text-slate-300">Basic (monthly)</p>
                  <p className="font-display font-bold text-slate-300">~₹500–800/mo</p>
                </div>
                <div className="flex items-baseline justify-between">
                  <p className="font-medium text-slate-300">Premium (monthly)</p>
                  <p className="font-display font-bold text-slate-300">~₹1,500–2,000/mo</p>
                </div>
              </div>
      ...
      <section className="px-5 py-20">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
              <p className="font-display font-bold text-white">Zety might suit you if you:</p>
              <ul className="mt-4 space-y-2 text-sm text-slate-300">
                {[
          ...
          __html: JSON.stringify([
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { '@type': 'ListItem', position: 3, name: 'CV Prime vs Zety', item: 'https://cv-prime.in/cv-prime-vs-zety' },
              ],
            },
          ]),
        }}
