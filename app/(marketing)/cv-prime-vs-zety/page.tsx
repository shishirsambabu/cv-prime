...
const features = [
  ...
  { feature: 'INR pricing (India)', cvPrime: 'yes', zety: 'no', note: 'CV Prime is ₹999 one-time lifetime; Zety charges in USD (≈₹1,500–2,500/month equivalent)' },
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Zety charges in USD, with Pro plans typically ranging from $5.99 to $23.70/month. At current exchange rates, this equates to approximately ₹500–₹2,000/month — many times the cost of CV Prime Lifetime Pro (₹999 one-time). Additionally, Zety does not accept Indian payment methods like UPI or net banking.',
  },
  {
  ...
  },
  {
    ...
    a: 'Yes. CV Prime\'s free plan includes 3 PDF exports, full ATS scoring, AI bullet rewrites, all 8 templates, and the job tracker — no credit card required. This lets you fully evaluate the platform before upgrading to Lifetime Pro (₹999 one-time).',
  },
  {
