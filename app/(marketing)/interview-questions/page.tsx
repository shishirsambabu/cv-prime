      ...
      <section className="bg-slate-950 px-5 py-20 text-white">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
            Free interview question guides for {roles.length} roles across technology, finance, marketing, operations, and more. Each guide covers the questions Indian recruiters actually ask — with detailed model answers.
          </p>
        </div>
      </section>
