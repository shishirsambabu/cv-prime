...
const softwareApplicationSchema = {
  ...
  featureList: [
    ...
    'CV examples for 50 roles across tech, business, and operations',
    'Resume examples for 50 roles across tech, business, and operations',
    'Interview question guides for 50 roles',
    'Salary guides for 50 roles in India',
    'LinkedIn headline templates for 50 roles',
    'ATS optimisation guides for 50 roles',
    'Cover letter examples for 50 roles',
  ],
};
