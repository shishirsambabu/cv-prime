...
const softwareApplicationSchema = {
  ...
  featureList: [
    ...
    'CV examples for 40 roles across tech, business, and operations',
    'Interview question guides for 40 roles',
    'Salary guides for 40 roles in India',
    'LinkedIn headline templates for 40 roles',
    'ATS optimisation guides for 40 roles',
    'Cover letter examples for 40 roles',
  ],
};
