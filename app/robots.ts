...
export default function robots(): MetadataRoute.Robots {
  return {
    rules: [
      {
        userAgent: '*',
        allow: ['/', '/templates', '/pricing', '/contact', '/terms', '/privacy', '/refund', '/cookies', '/llm.txt', '/online-cv-maker', '/ai-cv-builder', '/ats-friendly-cv', '/ats-checker', '/cv-builder-india', '/resume-vs-cv', '/cv-examples', '/cover-letter', '/statistics', '/about', '/interview-questions', '/linkedin-headline', '/resume-builder', '/free-resume-builder', '/resume-checker', '/fresher-resume', '/resume-format', '/cover-letter-examples', '/create-with-ai', '/ethics'],
