...
const publicPaths = [
  ...
  '/tools/resume-strength-analyzer',
  '/tools/cgpa-to-percentage',
  '/tools/resume-bullet-analyzer',
  '/tools/cover-letter-checker',
  '/tools/linkedin-character-counter',
  '/tools/ai-ats-score',
  '/tools/ai-bullet-rewriter',
  '/tools/ai-cover-letter',
  '/tools/ai-cv-roast',
  '/tools/ai-jd-decoder',
  '/tools/ai-jd-generator',
  '/tools/ai-interview-questions',
  '/tools/ai-role-fit',
  '/tools/ai-linkedin',
  '/tools/ai-outreach-email',
  '/tools/ai-salary-negotiation',
  '/tools/ai-skills-gap',
  '/embed',
