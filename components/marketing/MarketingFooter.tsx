...
const footerColumns: Array<{ title: string; links: Array<{ label: string; href: string }> }> = [
  {
    ...
    links: [
      ...
      { label: 'All tools & guides', href: '/resume-tools' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'How to write a CV', href: '/how-to-write-a-cv' },
      { label: 'Skills for a resume', href: '/skills-for-resume' },
      { label: 'Resume objective examples', href: '/resume-objective-examples' },
      { label: 'Fresher resume guide', href: '/fresher-resume' },
      { label: 'Experienced resume guide', href: '/resume-builder-for-experienced' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Delhi NCR', href: '/resume-builder-delhi' },
