...
const footerColumns: Array<{ title: string; links: Array<{ label: string; href: string }> }> = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Career & ATS glossary', href: '/glossary' },
    ],
  },
  {
    title: 'Cities',
    links: [
      ...
      { label: 'Resume builder Kolkata', href: '/resume-builder-kolkata' },
      { label: 'Resume builder Ahmedabad', href: '/resume-builder-ahmedabad' },
    ],
  },
  {
    title: 'Compare',
