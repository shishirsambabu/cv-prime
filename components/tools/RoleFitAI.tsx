  ...
  return (
    <div className="space-y-6">
      <form onSubmit={onSubmit}>
        <ToolCard>
          <ToolTextarea label="Your resume" value={resume} onChange={setResume} placeholder="Paste your full resume — the AI will suggest the roles you're most competitive for…" rows={12} />
          <div className="mt-5">
