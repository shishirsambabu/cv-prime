 ...
 *
 * `slug`, `appName`, `appDescription`, and `faqs` drive the visible FAQ
 * section plus FAQPage/WebApplication/BreadcrumbList JSON-LD, so each tool
 * page carries the structured data AI crawlers and search engines use to
 * understand and cite it (the marketing tool pages already do this; the
 * BYOK AI tools previously shipped with none).
 */
      ...
      {faqs.length > 0 ? (
        <section className="border-t border-white/10 bg-white/[0.02] px-5 py-16 sm:px-6">
          <div className="mx-auto max-w-3xl">
            <h2 className="text-center font-display text-2xl font-bold text-white sm:text-3xl">{appName} — FAQ</h2>
