...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    heroSubheading: '75% of resumes are rejected by ATS before a human ever reads them — usually because the right keywords are missing. Use this list to match your resume to what the algorithm (and hiring manager) is scanning for.',
    sections: [
      {
        heading: 'Why ATS Keywords Matter More Than You Think',
        body: 'Applicant Tracking Systems parse your resume and score it against a keyword checklist extracted from the job description. A resume that scores below the threshold — typically 60–70% keyword match — is filtered out automatically. Adding the right keywords is not keyword-stuffing; it is making sure your genuine skills are expressed in the vocabulary the system recognises.',
        items: [
          '75% of resumes are rejected by ATS before reaching a recruiter (Jobscan 2025)',
          'Resumes with a 70%+ keyword match are 3× more likely to get a callback',
          'Missing even 2–3 critical role-specific keywords can drop your score below the threshold',
          'Synonyms matter: "led" vs "managed" vs "oversaw" — ATS may not equate them',
        ],
      },
      {
        heading: 'How to Find the Right Keywords for Your Resume',
        body: 'The best keywords come directly from the job description — not from generic lists. Use this three-step process before applying to any role.',
        items: [
          '1. Copy the full JD into a text file. Highlight every noun and verb that describes skills, tools, certifications, and outcomes',
          '2. Identify which appear 2+ times — those are the highest-weight terms',
          '3. Cross-check against your experience. Use exact phrasing where accurate; paraphrase only where synonymous',
          '4. Use CV Prime\'s ATS Keyword Matcher to automate steps 1–3 in 30 seconds',
        ],
        tip: 'Use the exact spelling and capitalisation from the JD: "JavaScript" not "Javascript", "SQL Server" not "SQL server". ATS matching is often case-sensitive for technical terms.',
      },
      {
        heading: 'ATS Keywords by Role — Software Engineering',
        body: 'Keywords for software engineer, full-stack, backend, and SDE roles at Indian tech companies and MNCs.',
        items: [
          'Languages: Python, Java, JavaScript, TypeScript, Go, Rust, C++, Kotlin, Swift',
          'Frameworks: React, Node.js, Spring Boot, Django, FastAPI, Next.js, Angular, Vue',
          ...
          'Practices: microservices, REST API, GraphQL, agile, scrum, system design, distributed systems',
          'Soft skills (contextualised): cross-functional collaboration, technical mentoring, code review',
        ],
      },
      {
        heading: 'ATS Keywords by Role — Data & Analytics',
        body: 'Keywords for data analyst, data scientist, business analyst, and ML engineer roles.',
        items: [
          'Tools: Python, R, SQL, Tableau, Power BI, Looker, Excel, Google Sheets',
          'ML/AI: scikit-learn, TensorFlow, PyTorch, XGBoost, NLP, computer vision, LLMs',
          'Cloud: BigQuery, Redshift, Snowflake, Databricks, Azure ML, AWS SageMaker',
          'Methods: A/B testing, regression, classification, clustering, feature engineering, ETL',
          'Domains: product analytics, revenue analytics, supply chain, customer segmentation, forecasting',
        ],
      },
      {
        heading: 'ATS Keywords by Role — Marketing',
        body: 'Keywords for digital marketing, performance marketing, content, and growth roles.',
        items: [
          'Channels: SEO, SEM, Google Ads, Meta Ads, LinkedIn Ads, email marketing, affiliate',
          'Tools: Google Analytics 4, HubSpot, Salesforce, Mailchimp, Hootsuite, Semrush, Ahrefs',
          'Metrics: CAC, LTV, ROAS, CTR, CPC, MQL, SQL, conversion rate, organic traffic',
          'Skills: content strategy, brand positioning, performance marketing, growth hacking, funnel optimisation',
          'Platforms: Instagram, YouTube, LinkedIn, Twitter/X, Naukri, Indeed',
        ],
      },
      {
        heading: 'ATS Keywords by Role — Finance & Accounting',
        body: 'Keywords for CA, finance analyst, CFO office, and investment roles.',
        items: [
          'Certifications: CA, CFA, CMA, ACCA, MBA Finance, FRM',
          'Skills: financial modelling, DCF, valuation, budgeting, forecasting, variance analysis',
          'Tools: SAP, Oracle Financials, Tally ERP, MS Excel (advanced), Power BI, QuickBooks',
          'Domains: FP&A, treasury, accounts payable/receivable, audit, tax, transfer pricing',
          'Regulations: IFRS, IndAS, GST, Companies Act, SEBI compliance, RBI norms',
        ],
      },
      {
        heading: 'ATS Keywords by Role — HR & People',
        body: 'Keywords for HR generalist, talent acquisition, L&D, and HRBP roles.',
        items: [
          'Core: talent acquisition, employee relations, performance management, L&D, HRBP',
          'Tools: Darwinbox, Workday, SAP SuccessFactors, Zoho People, BambooHR, Taleo',
          'Skills: employer branding, onboarding, attrition management, compensation benchmarking',
          'Certifications: PHR, SHRM-CP, XLRI HR, Psych background, NLP practitioner',
          'Metrics: time-to-hire, cost-per-hire, eNPS, attrition rate, offer acceptance rate',
        ],
      },
      {
        heading: 'Universal Power Keywords — Action Verbs That Score High',
        body: 'These action verbs appear consistently in high-scoring resumes across all industries. Use them to open bullet points.',
        items: [
          'Leadership: led, managed, directed, oversaw, spearheaded, championed, established',
          'Achievement: achieved, delivered, exceeded, surpassed, generated, increased, reduced',
          'Building: built, designed, developed, created, launched, architected, deployed',
          'Analysis: analysed, evaluated, assessed, identified, quantified, benchmarked, modelled',
          'Collaboration: collaborated, partnered, coordinated, facilitated, aligned, influenced',
        ],
        tip: 'Avoid passive constructions: "was responsible for" or "helped with" score lower than direct action verbs. Every bullet should start with a past-tense verb.',
      },
      {
        heading: 'Keywords to Avoid (Overused & Low-Signal)',
        body: 'These terms are so generic that ATS systems and recruiters effectively ignore them. Remove them or replace with specific equivalents.',
        items: [
          '"Team player" → replace with a specific cross-functional project',
          '"Hard worker" → show via quantified outcomes',
          '"Result-oriented" → just show the results',
          '"Detail-oriented" → demonstrate via accuracy metrics or QA work',
          '"Self-starter" → describe what you initiated without being asked',
          '"Passionate about" → omit — passion is shown, not stated',
        ],
      },
    ],
    faqs: [
      {
        ...
        a: 'Focus on quality over quantity. Aim for a 70–80% match with the job description\'s key terms rather than stuffing every possible keyword. A typical ATS-optimised resume includes 15–25 role-specific keywords woven naturally into bullet points and the skills section.',
      },
      {
        q: 'Should I have a separate keywords section in my resume?',
        a: 'Yes — a dedicated "Core Skills" or "Technical Skills" section helps ATS parse your capabilities quickly. List 10–18 hard skills as a comma-separated or grid list. Soft skills are better demonstrated in bullet points rather than listed in a skills section.',
      },
      {
        q: 'Do I need different keywords for Naukri vs LinkedIn vs direct applications?',
        a: 'The keywords should come from each specific JD, so they will naturally vary. However, Naukri places extra weight on skills listed in the dedicated skills field and your headline. LinkedIn ATS (used by companies posting on LinkedIn) weights the Skills section and headline similarly.',
      },
      {
        q: 'What is the best tool to find ATS keywords for my resume?',
        a: 'CV Prime\'s ATS Keyword Matcher extracts the key terms from any job description and shows you which are present and missing in your resume — ranked by frequency and importance. It takes 30 seconds and is free without a signup.',
      },
      {
        q: 'Can I just copy keywords from the JD directly?',
        a: 'Only if those skills accurately describe you. Keyword stuffing — adding terms you cannot demonstrate — will backfire in the interview. The goal is to surface genuine skills using the same vocabulary the JD uses, not to claim skills you do not have.',
      },
    ],
    ctaHeading: 'Find your missing ATS keywords — free, 30 seconds',
    ctaBody: 'Paste any job description into CV Prime\'s ATS Keyword Matcher. It instantly shows which keywords are in your resume and which are missing — so you can add them before submitting.',
  ...
  },
  {
    ...
    heroSubheading: 'Project management roles in India are booming — IT PM, delivery manager, scrum master, and construction PM are all high-demand. Here\'s how to write a resume that gets past ATS and lands you interviews at TCS, Infosys, Wipro, Deloitte, and product companies.',
    sections: [
      {
        heading: 'What Indian Employers Look for in a PM Resume',
        body: 'Project management hiring in India splits across two tracks: IT/software PM roles (product companies, consulting, BFSI IT) and functional PM roles (construction, manufacturing, infrastructure). Both require a resume that demonstrates delivery track record, not just process knowledge.',
        items: [
          'Quantified delivery outcomes: budget saved, timelines met, scope delivered on schedule',
          'Methodology clarity: Agile/Scrum, PMP (Waterfall), PRINCE2, SAFe, or hybrid',
          'Stakeholder management evidence: cross-functional teams, client-facing delivery, C-suite reporting',
          'Tools proficiency: Jira, MS Project, Asana, Trello, Confluence, Monday.com',
          'Scale indicators: team size, budget managed, number of concurrent projects',
          'Certifications: PMP, CAPM, CSM, PMI-ACP, PRINCE2, SAFe',
        ],
      },
      {
        heading: 'Resume Format for Project Managers in India',
        body: 'Use a reverse-chronological format with a strong 3–4 line professional summary at the top. Most Indian PM roles at the 5–15 year experience level expect a 2-page resume.',
        items: [
          'Section order: Summary → Core Competencies → Work Experience → Certifications → Education',
          'Summary: state your years of experience, domain (IT/infra/product), methodology expertise, and one headline outcome',
          'Core Competencies: 12–16 keywords in a 2–3 column grid (ATS-critical section)',
          'Work Experience: 4–6 bullets per role, each starting with a strong verb + metric',
          'Certifications: list PMP, CSM, etc. with issuing body and validity year',
          'Education: MBA/B.Tech/B.E. — list CGPA only if above 7.5 or asked',
        ],
        tip: 'Avoid listing project phases as separate jobs. If you managed multiple projects at one company, group them under the employer with subheadings or a project table.',
      },
      {
        heading: 'Strong PM Bullet Point Examples',
        body: 'Transform vague duties into measurable impact using the CAR format (Context → Action → Result).',
        items: [
          'Weak: "Managed a digital transformation project" → Strong: "Led ₹4.2Cr digital transformation of ERP systems across 3 business units, delivered 3 months ahead of schedule, reducing manual processing time by 40%"',
          'Weak: "Worked with cross-functional teams" → Strong: "Coordinated 18-member cross-functional team (Engineering, QA, Design, Legal) to deliver mobile banking app; achieved 98% sprint velocity across 8 sprints"',
          'Weak: "Responsible for stakeholder communication" → Strong: "Produced weekly C-suite status reports and chaired monthly steering committee for ₹12Cr infrastructure programme; zero escalations across 18-month delivery"',
          'Weak: "Managed project budget" → Strong: "Managed ₹7.8Cr capex budget with 2.1% underspend; reallocated savings to accelerate Phase 2 delivery by 6 weeks"',
        ],
      },
      {
        heading: 'Must-Have Keywords for ATS — Project Management',
        body: 'Include these across your Core Competencies section, summary, and bullet points.',
        items: [
          'Methodologies: Agile, Scrum, Waterfall, PRINCE2, SAFe, Kanban, hybrid delivery',
          'Tools: Jira, MS Project, Confluence, Asana, Trello, Smartsheet, Monday.com, Miro',
          'Competencies: stakeholder management, risk management, change management, resource planning, scope management',
          'Certifications (text): PMP, CAPM, CSM (Certified Scrum Master), PMI-ACP, PRINCE2 Practitioner, SAFe Agilist',
          'IT-specific: SDLC, sprint planning, velocity, release management, SLA, cloud migration, vendor management',
          'Metrics: on-time delivery, budget variance, earned value management (EVM), NPS, CSAT',
        ],
      },
      {
        heading: 'PMP Certification on Your Resume',
        body: 'If you hold a PMP, place it prominently — in your resume headline, summary, and certifications section. Indian IT companies specifically filter for PMP on Naukri and LinkedIn.',
        items: [
          'Headline example: "PMP-Certified IT Project Manager | Agile | Digital Transformation | 9 Years"',
          'Summary mention: "PMP-certified project manager with 9 years delivering IT transformation projects..."',
          'Certifications section: "Project Management Professional (PMP) — PMI, 2023–2026 (Renewal)"',
          'If pursuing PMP: "PMI PMP — In Progress, Exam Scheduled Q3 2026" is acceptable for senior roles',
          'CSM + PMP together is a strong combination for Agile-heavy companies like product startups',
        ],
        tip: 'If you do not have a PMP yet, a CSM (Certified Scrum Master) or PMI-ACP is accepted for Agile PM and delivery manager roles at most Indian IT and product companies.',
      },
      {
        heading: 'Salary Expectations for Project Managers in India (2026)',
        body: 'Compensation varies significantly by domain, company type, and whether you have a PMP.',
        items: [
          'Junior PM / Associate PM (2–4 yrs): ₹6L–₹14L (IT services), ₹10L–₹20L (product companies)',
          'Mid PM (5–8 yrs): ₹14L–₹28L (IT services), ₹22L–₹45L (product/consulting)',
          'Senior PM / Delivery Manager (9–15 yrs): ₹28L–₹55L (IT services), ₹45L–₹90L (MNC/product)',
          'Programme Manager / Director (15+ yrs): ₹60L–₹1.5Cr at tier-1 companies',
          'PMP-certified PMs typically command 15–25% premium over non-certified peers at same experience level',
        ],
      },
      {
        heading: 'Common Mistakes on Project Manager Resumes in India',
        body: 'These are the patterns that tank good PM resumes in ATS screening and recruiter review.',
        items: [
          'Listing activities instead of outcomes ("Conducted stand-ups" has zero weight; "Maintained 94% sprint goal achievement across 12 sprints" does)',
          'Omitting team and budget scale — two of the first filters recruiters apply',
          'Using "PM" abbreviation without spelling out "Project Manager" at least once (ATS may not equate them)',
          'One-page resume at 8+ years of experience — Indian PM roles expect 2 pages at this level',
          'Not specifying methodology — "managed projects" tells a recruiter nothing about whether you fit their Agile vs Waterfall environment',
          'Listing PMP in Education instead of a dedicated Certifications section',
        ],
      },
    ],
    faqs: [
      {
        q: 'Should I use a functional or chronological resume format as a project manager in India?',
        a: 'Chronological (reverse-chronological) is strongly preferred by Indian recruiters and ATS systems. Functional resumes that group skills without clear employment timelines raise red flags. If you have gaps to address, add a brief explanation in your cover letter or summary rather than switching format.',
      },
      {
        q: 'How do I show project management experience if I do not have a PM title yet?',
        a: 'Focus on PM activities in your bullet points: led a team, managed a deadline, coordinated stakeholders, tracked budget. Add a Core Competencies section with PM keywords. Pursue a CSM or PMI-ACP to signal intent. Many Indian companies hire developers or BAs into PM roles based on demonstrated PM activities rather than title.',
      },
      {
        q: 'Is PMP certification mandatory for project manager jobs in India?',
        a: 'Not mandatory, but increasingly expected above 7–8 years of experience at MNCs, consulting firms, and large IT services companies. For product startups, CSM or PMI-ACP is often preferred. For government/PSU projects, PRINCE2 is sometimes specified. For early-career roles (under 5 years), no certification is expected — outcomes matter more.',
      },
      {
        q: 'Should I include all projects I have managed or only the most important ones?',
        a: 'Include the 2–3 most impactful projects per employer, not an exhaustive list. Recruiters spend 6–10 seconds on initial screening — a tight, high-impact selection lands better than a comprehensive log. Prioritise projects with the largest budget, team, complexity, or outcome.',
      },
      {
        q: 'What is the best resume format for an IT project manager resume in India?',
        a: 'Use a clean, single-column ATS-safe format. No tables, text boxes, or graphics. Font size 10–12pt, margins 0.75–1 inch. The preferred structure is: Headline → Summary (3–4 lines) → Core Competencies (2-column grid) → Work Experience (reverse-chronological) → Certifications → Education. Save as PDF unless the JD specifies Word.',
      },
    ],
    ctaHeading: 'Build your project manager resume with CV Prime — free',
    ctaBody: 'CV Prime\'s AI tailors your project manager resume to the specific JD — adding missing PM keywords, strengthening bullet points, and generating an ATS score so you know exactly where you stand before you apply.',
    relatedSlugs: ['ats-resume-mistakes', 'how-to-write-resume-summary-2026', 'how-to-write-skills-section-resume-2026', 'business-analyst-resume-india-2026'],
  },
  {
    ...
    heroSubheading: 'Consulting resumes in India follow a distinct standard — whether you\'re targeting MBB (McKinsey, BCG, Bain), Big 4 (Deloitte, EY, KPMG, PwC), IT consulting (Accenture, Capgemini, IBM), or boutique strategy firms. This guide breaks down exactly what works.',
    sections: [
      {
        heading: 'What Makes a Consulting Resume Different',
        body: 'Consulting firms apply stricter resume standards than most other industries. A few structural and language norms are non-negotiable in the Indian consulting hiring context.',
        items: [
          'Impact-first bullets: every bullet must lead with a quantified outcome, not an activity',
          'STAR compression: situation + task + action + result, compressed to a single line',
          'Clean formatting: single column, no colour, no graphs — all Indian consulting ATS are sensitive to visual noise',
          'Tight length: 1 page for under 5 years of experience; 2 pages maximum for senior hires',
          'Strong academics: CGPA/percentage included if above 7.5 — Indian consulting firms weight academics significantly for campus and early-career hiring',
          'Firm-name recognition: if you consulted for a Fortune 500 or Nifty 50 client, name them if the engagement was public',
        ],
      },
      {
        heading: 'Consulting Resume Format & Section Order',
        body: 'Follow this structure for all consulting applications in India — it mirrors what McKinsey India, BCG India, Deloitte India, and KPMG India hiring teams expect.',
        items: [
          '1. Contact: Name (large, bold), phone, email, LinkedIn, city',
          '2. Education: for MBB / Big 4, education goes FIRST for MBA and campus hires (reverse-chronological: MBA → graduation)',
          '3. Work Experience: reverse-chronological, 3–5 bullets per role',
          '4. Skills: 8–12 items in two columns — tools, languages, methodologies',
          '5. Achievements / Leadership (optional): competitions, publications, notable outcomes outside work',
        ],
        tip: 'For experienced hires (5+ years), Work Experience moves to the top and Education drops to the bottom. For MBA campus recruits, Education with CGPA and institution name anchors the resume at the top.',
      },
      {
        heading: 'High-Impact Bullet Point Examples for Consulting',
        body: 'Every consulting bullet should follow the Impact + Action + Context pattern. Read these examples and notice how specificity creates credibility.',
        items: [
          'Weak: "Worked on cost reduction project" → Strong: "Identified ₹18Cr annual savings opportunity across 4 supply chain nodes for a Nifty 50 FMCG client through zero-based budgeting analysis"',
          'Weak: "Prepared client presentations" → Strong: "Authored 42-slide strategic roadmap presented to CFO and Board of a ₹2,800Cr pharma company, securing ₹340Cr capex approval for digital transformation"',
          'Weak: "Interviewed stakeholders" → Strong: "Conducted 28 structured interviews with C-suite and middle management across 3 BUs to map ₹90Cr procurement inefficiency; findings became foundation for 3-year transformation plan"',
          'Weak: "Led team of analysts" → Strong: "Managed 4-analyst engagement team delivering $1.2M market entry study for APAC consumer electronics brand; project delivered 2 weeks ahead of contract deadline"',
        ],
      },
      {
        heading: 'ATS Keywords for Consulting Resumes',
        body: 'Consulting ATS systems (Workday at MBB, Taleo at Big 4) keyword-match against the role specification. Include these across your resume.',
        items: [
          'Core consulting: strategy, management consulting, business transformation, due diligence, market entry, go-to-market',
          'Analytics: data analysis, financial modelling, DCF, market sizing, benchmarking, scenario analysis',
          'Tools: PowerPoint, Excel (advanced), Tableau, Power BI, SQL, Python (for strategy + tech consulting)',
          'Frameworks: Porter\'s 5 Forces, BCG matrix, MECE, issue tree, root cause analysis, zero-based budgeting',
          'Domains: digital transformation, cost reduction, operational efficiency, M&A, post-merger integration, ESG',
          'Soft skills (contextualised): stakeholder management, C-suite communication, executive presentations, workshop facilitation',
        ],
      },
      {
        heading: 'MBA Consulting Resume — India-Specific Guidance',
        body: 'MBA recruiting at IIMs and ISB follows a slightly different resume convention than lateral hiring.',
        items: [
          'Keep to strictly 1 page — summer intern and final placement committees reject multi-page resumes from MBA candidates',
          'List institution first: "Indian Institute of Management Ahmedabad, MBA, 2024–2026, CGPA: 3.7/4.0"',
          'Include pre-MBA experience but compress: 1–2 bullets per pre-MBA role, focus on scale and impact',
          'Club and committee roles matter: Consulting Club, Case Study Competition wins, cultural committee leadership',
          'Competitions: list cases won (BCG Online Case, McKinsey Solve, Deloitte Case) with placement (winner / finalist / top 5%)',
          'Summer internship goes immediately after education if converting to full-time at same firm',
        ],
        tip: 'For PPO (Pre-Placement Offer) situations, your intern project slide deck and the final feedback rating matter more than the resume itself. Focus your resume energy on lateral and competing offers.',
      },
      {
        heading: 'IT Consulting Resume — Accenture, Capgemini, IBM, TCS Consulting',
        body: 'IT consulting at large firms requires a hybrid of technical and consulting keywords. The evaluation weighs both.',
        items: [
          'Lead with a domain + technology combination: "SAP FICO Consultant | BFSI | 7 Years"',
          'Certifications matter more: SAP Certified, Salesforce Admin/Architect, ServiceNow CSA, Oracle Certified',
          'Client names often more important than bullet content at screening stage',
          'Include billable hours or utilisation rate if above average: "Maintained 94% billability across FY25 with zero client escalations"',
          'System integration, change management, and end-user training are differentiating keywords for IT consulting',
        ],
      },
      {
        heading: 'Consulting Salaries in India 2026',
        body: 'Compensation varies significantly by firm tier, role type, and experience.',
        items: [
          'MBB (McKinsey, BCG, Bain India) — MBA hire: ₹30L–₹40L CTC + ₹5L–₹10L signing bonus',
          'Big 4 consulting (Deloitte, EY, KPMG, PwC India) — MBA hire: ₹20L–₹28L CTC',
          'Boutique strategy / implementation firms: ₹12L–₹24L (experienced) to ₹18L–₹35L (MBA)',
          'IT consulting (Accenture Strategy, IBM Consulting, Capgemini Invent): ₹10L–₹45L depending on seniority and certification',
          'Senior Manager / Principal at Big 4: ₹35L–₹65L; Director/Partner track: ₹70L–₹1.5Cr+',
        ],
      },
    ],
    faqs: [
      {
        q: 'Should I use a one-page or two-page resume for consulting jobs in India?',
        a: 'One page for MBA campus recruiting and under 5 years of experience. Two pages maximum for experienced lateral hires with 5–15+ years. MBB India and Big 4 India specifically enforce 1-page for MBA campus recruiting — a 2-page submission from a campus candidate is often rejected before reading.',
      },
      {
        q: 'How important is CGPA / percentage for consulting resumes in India?',
        a: 'Very important for campus recruiting. McKinsey India and BCG India have published academic cutoffs (typically 7.5+ CGPA from Tier-1 colleges). For lateral hires with 3+ years of experience, CGPA becomes less relevant — work impact takes over. Always include CGPA if it is above the threshold; omit or list as "available on request" if below 7.0.',
      },
      {
        q: 'Do I need a cover letter for consulting applications in India?',
        a: 'For MBB and top Big 4 campus positions: yes, a tailored 1-page cover letter is expected and read carefully. It is your opportunity to explain why this specific firm and practice area. For IT consulting or mid-tier firms: a cover letter is often optional and less scrutinised, but a strong one can differentiate.',
      },
      {
        q: 'What certifications help a consulting resume in India?',
        a: 'For management consulting: CFA (finance-heavy practices), PMP (transformation projects), data science certifications (analytics practices). For IT consulting: SAP, Salesforce, ServiceNow, Oracle, AWS, Azure certifications are highly valued. For digital consulting: Google Analytics, HubSpot, and cloud architect certs. Pick certifications aligned to your target practice area.',
      },
      {
        q: 'How do I write a consulting resume if I have never worked at a consulting firm?',
        a: 'Frame internal projects as consulting engagements: you identified a problem, proposed a solution, coordinated stakeholders, and delivered measurable outcomes. Use the same impact-first bullet structure. Highlight any external advisory, freelance strategy, or client-facing work. Case competition wins from IIM/ISB are also strong proxies for consulting aptitude on a campus resume.',
      },
    ],
